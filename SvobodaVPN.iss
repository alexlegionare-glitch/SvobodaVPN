...
[Icons]
Name: "{commondesktop}\Свобода VPN"; Filename: "wscript.exe"; Parameters: """{app}\run.vbs"""; WorkingDir: "{app}"; IconFilename: "{app}\svoboda.ico"
Name: "{group}\Свобода VPN";         Filename: "wscript.exe"; Parameters: """{app}\run.vbs"""; WorkingDir: "{app}"; IconFilename: "{app}\svoboda.ico"
...
Filename: "wscript.exe"; Parameters: """{app}\run.vbs"""; Description: "Запустить «Свобода VPN»"; Flags: postinstall nowait skipifsilent
